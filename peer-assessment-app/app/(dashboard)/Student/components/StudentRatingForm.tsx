...
export default function RatingForm({courseId}: {courseId: number}) {
  const [selectedTeammate, setSelectedTeammate] = useState<Teammate | string>(''); // Store entire teammate object
  ...
  const handleFormChange = (name: keyof Ratings) => (
  ...
  const handleConfirmSubmit = async () => {
    ...
    try {
      const overallScore = (ratings.cooperation + ratings.conceptual + ratings.practical + ratings.workEthic) / 4;
    ...
    <Box component="form" sx={formStyle}>
      ...
      <FormControl fullWidth sx={{ mb: 3, mt: 1 }}>
        ...
        <Select
          ...
          id="teammate-select"
          value={selectedTeammate ? String((selectedTeammate as Teammate).s_id) : ''}
        ...
        {[
          ...
          <Box sx={{ my: '2' }} key={index}>
            <div style={{ display: 'flex', alignItems: 'center', paddingBottom: '10px', justifyContent: 'space-between' }}>
              ...
              <StyledTooltip content={item.tooltip} placement="right-start" closeDelay={100}>
            ...
            <TextField
              ...
              onChange={(e) => handleFormChange(`${item.value}Comment` as keyof Ratings)(e)}
              sx={{
                mt: '1',
      ...
      <Button 
        type="button" 
        variant="contained" 
        sx={{ backgroundColor:'#800020', marginTop: '20px', alignSelf: 'center' }}   
      ...
      >
        ...
        <DialogContent>
          <DialogContentText id="confirm-dialog-description">
            Are you sure you want to submit this evaluation? If you have already submitted an evaluation for this student, your previous evaluation will be overwritten.
          </DialogContentText>
        </DialogContent>
        <DialogActions>
