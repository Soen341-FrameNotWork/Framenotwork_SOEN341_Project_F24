...
export default function RatingForm({ courseId }: { courseId: number }) {
    ...
    const handleConfirmSubmit = async () => {
        ...
        try {
            ...
            alert(
                "There was an error submitting your ratings. Please try again.",
            );
        }
    ...
    return (
        <Box component="form" sx={formStyle}>
            ...
            <FormControl fullWidth sx={{ mb: 3, mt: 1 }}>
                <InputLabel id="teammate-select-label">
                    Select Teammate
                </InputLabel>
                <Select
                    ...
                    value={
                        selectedTeammate
                            ? String((selectedTeammate as Teammate).s_id)
                            : ""
                    }
                    ...
                    <Box sx={{ my: "2" }} key={index}>
                        ...
                        >
                            <Typography id={`${item.value}-label`}>
                                {item.label}:{" "}
                                {ratings[item.value as keyof Ratings]}
                            </Typography>
                            <StyledTooltip
                        ...
                        <StyledSlider
                            value={
                                ratings[item.value as keyof Ratings] as number
                            }
                            onChange={handleFormChange(
                                item.value as keyof Ratings,
                            )}
                        ...
                        <TextField
                            ...
                            value={
                                ratings[
                                    `${item.value}Comment` as keyof Ratings
                                ] as string
                            }
                            onChange={(e) =>
                                handleFormChange(
            ...
            >
                ...
                <DialogContent>
                    <DialogContentText id="confirm-dialog-description">
                        Are you sure you want to submit this evaluation? If you
                        have already submitted an evaluation for this student,
                        your previous evaluation will be overwritten.
                    </DialogContentText>
                </DialogContent>
                <DialogActions>
