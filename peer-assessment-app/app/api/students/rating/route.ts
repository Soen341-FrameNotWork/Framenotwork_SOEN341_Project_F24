  ...
  const categoryAverageScores = {
    cooperative_score:
      scoresCount.cooperative_score > 0
        ? parseFloat(
            (
              scoresSum.cooperative_score / scoresCount.cooperative_score
            ).toFixed(1),
          )
        : 0,
    conceptual_score:
      scoresCount.conceptual_score > 0
        ? parseFloat(
            (scoresSum.conceptual_score / scoresCount.conceptual_score).toFixed(
              1,
            ),
          )
        : 0,
    practical_score:
      scoresCount.practical_score > 0
        ? parseFloat(
            (scoresSum.practical_score / scoresCount.practical_score).toFixed(
              1,
            ),
          )
        : 0,
    work_ethic_score:
      scoresCount.work_ethic_score > 0
        ? parseFloat(
            (scoresSum.work_ethic_score / scoresCount.work_ethic_score).toFixed(
              1,
            ),
          )
        : 0,
